...
See sample: [`cmfrt-oauth2-setup-page-status-and-navigation.good.al`](cmfrt-oauth2-setup-page-status-and-navigation.good.al).
...
See sample: [`cmfrt-oauth2-setup-page-status-and-navigation.bad.al`](cmfrt-oauth2-setup-page-status-and-navigation.bad.al).

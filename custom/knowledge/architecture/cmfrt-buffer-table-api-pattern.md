...
See sample: [`cmfrt-buffer-table-api-pattern.good.al`](cmfrt-buffer-table-api-pattern.good.al).
...
See sample: [`cmfrt-buffer-table-api-pattern.bad.al`](cmfrt-buffer-table-api-pattern.bad.al).

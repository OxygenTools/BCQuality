...
- Tokens extracted from the diff: `ObsoleteState`, `ObsoleteReason`, `ObsoleteTag`, `Confirm`, `case`, `else`, `interface`, `implements`, `IntegrationEvent`, `OnBefore`, `OnAfter`, `Handled`, `IsHandled`, `IncludedPermissionSets`, `Assignable`, `procedure`, `local procedure`, `Validate`, `Init`, `Insert`, `OnInsertRecord`, `Buffer`, `Caption`, `ToolTip`, `Label`, `Comment`, `CopyStr`, `MaxStrLen`, `TryFunction`, `Codeunit.Run`, `field(`, `value(`, `namespace`, `using`, `Database::`, `Page::`, `Codeunit::`, `Enum::`, `extends`, `OnDelete`, `Delete`, `DeleteAll`, `TableRelation`, `OnAfterDeleteEvent`, `IsTemporary`, `Subtype = Test`, `[Test]`, `[HandlerFunctions]`, `[ConfirmHandler]`, `[MessageHandler]`, `[ModalPageHandler]`, `Image`, `action(`, `group(`, `fileuploadaction(`, `cuegroup(`, `area(Processing)`, `RoleCenter`.
